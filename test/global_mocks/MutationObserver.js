...
let interceptSetter = function (proto, propertyName, intercept) {
...
let interceptMethod = function (proto, methodName, intercept) {
...
function patchNotifyChange(window) {
    ...
    interceptMethod(node_proto, "appendChild", notify)
    interceptMethod(node_proto, "insertBefore", notify)
    interceptMethod(node_proto, "removeChild", notify)
    interceptMethod(node_proto, "replaceChild", notify)
    interceptSetter(node_proto, "nodeValue", notify)
    interceptSetter(node_proto, "textContent", notify)

    let element_proto = (window)._core.Element.prototype

    interceptMethod(element_proto, "setAttribute", notify)
    interceptMethod(element_proto, "removeAttribute", notify)
    interceptMethod(element_proto, "removeAttributeNode", notify)
    interceptMethod(element_proto, "removeAttributeNS", notify)
}
